...
const Footer = () => {
    ...
    return (
        ...
        <div className="px-4 bg-zinc-900 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
  ...
  blank
          ...
          <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
            <p className="text-sm text-gray-100">
              © Copyright 2020 Chroniclb All rights reserved.
            </p>
