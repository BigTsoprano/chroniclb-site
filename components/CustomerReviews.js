    ...
    return (
        ...
        <div className="glide-08  relative w-full">
          ...
          <div data-glide-el="track">
            <ul className="whitespace-no-wrap mt-8 flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0 pb-12">
              <li>
                <div className="h-full w-full">
                  {/*                    <!-- Start Testimonial --> */}
                  <div className="h-full overflow-hidden rounded-xl bg-white text-slate-500 shadow-2xl shadow-slate-200">
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        <blockquote className="p-6 text-lg leading-relaxed">
                          <p>
                          This place is great! Everyone here is awesome! Morning crew (my usual) night crew to the security guards are all awesome!Hefty the owner is a really good guy too, sometimes you’ll see him working the counter even. No surprise this place is run so well because the people here are the best.
                          </p>
                        </blockquote>
                  ...
                  <div className="h-full overflow-hidden rounded-xl bg-white text-slate-500 shadow-2xl shadow-slate-200">
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        <blockquote className="p-6 text-lg leading-relaxed">
                          <p>
                          Lily was the person that gave me excellent customer service. Thank u cause u had what we couldn't find elsewhere. My usual spot has been out but u had it in abundance. Made my 4th. Lily actually answered when my call was made to ask if u had it. Thanks Lily for ur excellent customer service.
                          </p>
                        </blockquote>
                        <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                          <span
