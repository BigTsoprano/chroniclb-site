...
const Glider = dynamic(() => import('../Elements/Glider'));import { motion } from "framer-motion"
...
function ProductTwo() {
  ...
  return (
    <div className="bg-green-100">
     <div className=" pt-8  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8  sm:max-w-xl md:max-w-full lg:max-w-screen-xl  ">
