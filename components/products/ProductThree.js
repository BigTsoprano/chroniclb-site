...
function ProductThree() {
  return (
    <>
    <div className=" pt-8  sm:max-w-xl md:max-w-full lg:max-w-screen-xl px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
      ...
      <Glider>
      <ul className="whitespace-no-wrap m-3 flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
