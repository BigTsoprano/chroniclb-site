...
function ProductOne() {
  ...
  return (
    <>
    <div className="pl-4 pt-8 px-4  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8  sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:pl-24 lg:pl-8 ">
